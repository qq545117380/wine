...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="${base}/back/index">醉美酒 后台管理</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li id="Hui-msg"> <a href="${base}/back/index" title="消息"><span class="badge badge-danger">0</span>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="${base}/back/orders/1" data-title="所有订单查询" href="javascript:void(0)">所有订单查询</a></li>
                    <li><a data-href="${base}/back/signOrder/1" data-title="签收订单查询" href="javascript:void(0)">签收订单查询</a></li>
                    <li><a data-href="${base}/back/rejectionOrder/1" data-title="拒收订单查询" href="javascript:void(0)">拒收订单查询</a></li>
                    <li><a data-href="${base}/back/unfilledOrder/1" data-title="未发货订单查询" href="javascript:void(0)">未发货订单查询</a></li>
                    <li><a data-href="${base}/back/returnOrder/1" data-title="退货订单查询" href="javascript:void(0)">退货订单查询</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="${base}/back/item/1" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
                </ul>
            </dd>
        </dl>
        <#--<dl id="menu-comments">-->
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="${base}/back/user/1" data-title="会员列表" href="javascript:;">会员列表</a></li>
        ...
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="${base}/back/users/1" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
                </ul>
            </dd>
        </dl>
        <#--<dl id="menu-tongji">-->
        ...
        <dl id="menu-system">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="${base}/back/log/1" data-title="日志查询" href="javascript:void(0)">用户登录日志</a></li>
                </ul>
            </dd>
        </dl>
    </div>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="welcome.ftl">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="${base}/welcome.html"></iframe>
        </div>
    </div>
</section>

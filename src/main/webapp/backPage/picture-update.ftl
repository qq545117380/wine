...
<div class="page-container">
    ...
    action="${base}/back/update" method="post" enctype="multipart/form-data" >
        <#--当前商品的id-->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemName}" placeholder="" id="" name="itemName">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">产品描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemDescribe}" placeholder="" id="" name="itemDescribe">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.regularPrice}" placeholder="" id="" name="regularPrice">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">活动价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.activityPrice}" placeholder="" id="" name="activityPrice">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemPromotionMsg}" placeholder="" id="" name="itemPromotionMsg">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemIntegral}" placeholder="" id="" name="itemIntegral">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">产品品牌：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemBrand}" placeholder="" id="" name="itemBrand">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">产品编号：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemSku}" placeholder="" id="" name="itemSku">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">产品容量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemContent}" placeholder="" id="" name="itemContent">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemProof}" placeholder="" id="" name="itemProof">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemReticule}" placeholder="" id="" name="itemReticule">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemFlavour}" placeholder="" id="" name="itemFlavour">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemCartonSpec}" placeholder="" id="" name="itemCartonSpec">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemSpec}" placeholder="" id="" name="itemSpec">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${item.itemStatus}" placeholder="" id="" name="itemStatus">
            </div>
        </div>

        <div class="row cl">

            <label class="form-label col-xs-4 col-sm-2">产品原图片：</label>
            <img height="100" width="100" src="${imagesPath}/${item.img1}"">
            <div class="formControls col-xs-8 col-sm-9">
                <p>请选择要修改的图片</p>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">修改商品信息：</label>
            <div class="formControls col-xs-8 col-sm-9">

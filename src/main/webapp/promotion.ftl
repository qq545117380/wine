<!DOCTYPE html>
<!-- saved from url=(0018)http://tm.gjw.com/ -->
<html lang="zh"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title> 酒水特卖_酒水团购_酒水促销_购酒网特卖会专场</title>
        <link href="http://tm.gjw.com/favicon.ico" rel="shortcut icon" type="image/x-icon">
       <meta name="keywords">
    <meta name="description">
            <link rel="stylesheet" type="text/css" href="${base}/promotion_files/swiper.css">
        <link href="${base}/promotion_files/index.min.css" rel="stylesheet">
        
     <script src="${base}/promotion_files/hm.js.下载"></script><script type="text/javascript" async="" src="${base}/promotion_files/dc.js.下载"></script><script src="${base}/promotion_files/jquery-1.7.1.min.js.下载"></script>
       
        <script>
            document.domain = "gjw.com"; 
        </script>

    <link rel="stylesheet" href="${base}/promotion_files/layer.css" id="layui_layer_skinlayercss" style=""><script type="text/javascript" async="async" charset="utf-8" src="${base}/promotion_files/userinfo.php"></script><script type="text/javascript" async="async" charset="utf-8" src="${base}/promotion_files/zh_cn.js.下载" data-requiremodule="lang"></script><script type="text/javascript" async="async" charset="utf-8" src="${base}/promotion_files/chat.in.js.下载" data-requiremodule="chatManage"></script><script type="text/javascript" async="async" charset="utf-8" src="${base}/promotion_files/mqtt31.js.下载" data-requiremodule="MQTT"></script><script type="text/javascript" async="async" charset="utf-8" src="${base}/promotion_files/mqtt.chat.js.下载" data-requiremodule="Connection"></script></head>
...
<!--首页头部s-->
		...
		<div class="topNav">
			<div class="topNavbox clearfix">
				<div class="focusbtn fl">
					<img src="${base}/promotion_files/ewms.png" width="12" height="12" alt="" original="/Images/ewms.png"><span> 购酒网APP </span><em> ﹀</em>
					<div class="ewm">
						<span class="sanjiao">◆</span>
						<img src="${base}/promotion_files/APP.png" original="http://order.gjw.com/image/APP.png">
					</div>
				</div>
		...
		<!--顶部导航e-->
		<!--大广告s-->
		<div class="topAd" id="bigimg" style="height: 80px;"><a href="http://www.gjw.com/Minisite/20180612/1509.htm" target="_blank"><img src="${base}/promotion_files/7f07b37d61e940398f4d0b3d754e4690.jpg" alt="" original="http://img0.gjw.com/Famous/2018/0412/7f07b37d61e940398f4d0b3d754e4690.jpg"></a></div>
		<!--大广告e-->
		<!--图标、搜索框、购物车s-->
		<div class="topItem">
			<a href="http://www.gjw.com/" class="fl topLogo">
                <img src="${base}/promotion_files/logo1.jpg" alt="购酒网" original="/Images/logo1.jpg">
            </a>
            	<div class="fl topGif" id="topGif"><a href="http://www.gjw.com/product/item-id-7625.html" target="_blank"><img src="${base}/promotion_files/093094c6ae204763b190aab9265e0f33.gif" alt="" original="http://img0.gjw.com/Famous/2018/0604/093094c6ae204763b190aab9265e0f33.gif"></a></div>
		...
		<div class="itemNav clearfix">
			<ul class="itemList fl">
				<li id="listnav">
					<a href="http://tm.gjw.com/">☰ &nbsp; 全 部 分 类</a>
					<ul class="qbfl-list">
					<li class="yjxg-on">
						<a href="http://tm.gjw.com/"> 
							<img src="${base}/promotion_files/ax-icon.png" original="/Content/head/img/ax-icon.png">&nbsp;一键选购</a><em>›</em>
						<div class="yjxg-box sec-box none" id="yijian"></div>
							
					</li>
					<li class="bj-on">
						<a href="http://www.gjw.com/baijiu">
							<img src="${base}/promotion_files/bj-icon.png" original="/Content/head/img/bj-icon.png">&nbsp;白 酒</a><em>›</em>
					...
					<li class="ptj-on">
						<a href="http://www.gjw.com/putaojiu">
							<img src="${base}/promotion_files/ptj-icon.png" original="/Content/head/img/ptj-icon.png">&nbsp;葡 萄 酒</a><em>›</em>
					...
					<li class="yj-on">
						<a href="http://www.gjw.com/yangjiu">
							<img src="${base}/promotion_files/yj-icon.png" original="/Content/head/img/yj-icon.png">&nbsp;洋 酒</a><em>›</em>
						<div class="yj-box sec-box none" id="yangjiu">
						</div>
					</li>
					<li class="hj-on">
						<a href="http://www.gjw.com/huangjiu">
							<img src="${base}/promotion_files/hj-icon.png" original="/Content/head/img/hj-icon.png">&nbsp;黄 酒</a><em>›</em>
					...
					<li class="ysj-on">
						<a href="http://www.gjw.com/qingjiu">
							<img src="${base}/promotion_files/ysj-icon.png" original="/Content/head/img/ysj-icon.png">&nbsp;清 酒</a><em>›</em>
					...
					<li class="pj-on">
						<a href="http://www.gjw.com/list/pijiu">
							<img src="${base}/promotion_files/pj-icon.png" original="/Content/head/img/pj-icon.png">&nbsp;啤 酒</a><em>›</em>
					...
					<li class="jjzb-on">
						<a href="http://www.gjw.com/list/jiujujigengduo">
							<img src="${base}/promotion_files/jjzb-icon.png" original="/Content/head/img/jjzb-icon.png">&nbsp;酒具周边</a><em>›</em>
						<div class="jjzb-box sec-box none" id="zb"> 
						</div>
					</li>
					<li class="xp-on">
						<a href="http://www.gjw.com/Search.html?Key=ALL">
							<img src="${base}/promotion_files/xp-icon.png" original="/Content/head/img/xp-icon.png">&nbsp;新 品</a><em>›</em>
						...
						<a href="http://www.gjw.com/qingcang/default.htm">
							<img src="${base}/promotion_files/qingcang.png" original="/Content/head/img/qingcang.png">&nbsp;清 仓</a><em>›</em>
								<div class="jjzb-box sec-box none">
										<div class="box-lt fl clearfix"></div>
								</div>
					</li>
...
<style>
body{font-family: 微软雅黑,Tahoma,Verdana;font-size: 12px; color: #333333; text-decoration: none; margin:0; padding:0; 	}
...
.tou{
	background: url(http://img0.gjw.com/Minisite/2017/ly/0429a/bg_01.jpg)50% 0;
	background-repeat:no-repeat;
	height:776px;
	width:auto;	
}

.bg{background: url(http://img0.gjw.com/Minisite/2017/ly/0429a/bg_02.jpg)50% 0;
	background-repeat:no-repeat;
	height:650px;
	width:auto;	
}
...
<div class="bg">
<div class="a"><img alt="" width="1040" height="650" usemap="#Map" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_02.jpg" src="${base}/promotion_files/lp_02.jpg" style="display: inline;">
  <map name="Map" id="Map">
...
<div class="a"><a href="http://www.gjw.com/product/item-id-7470.htm" target="_blank"><img alt="" width="1040" height="408" usemap="#Map2" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_03.jpg" src="${base}/promotion_files/lp_03.jpg" style="display: inline;">
    <map name="Map2" id="Map2">
      <area shape="rect" coords="6,8,1042,399" href="http://www.gjw.com/product/Item-ID-2304.htm" target="_blank">
    </map>
</a></div>
</div>
<div style="background-color:#ffc100;">
<div class="a"><a href="http://www.gjw.com/product/item-id-6187.htm" target="_blank"><img alt="" width="1040" height="410" usemap="#Map3" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_04.jpg" src="${base}/promotion_files/lp_04.jpg" style="display: inline;">
    <map name="Map3" id="Map3">
      <area shape="rect" coords="41,15,1040,404" href="http://www.gjw.com/product/item-id-7454.htm" target="_blank">
    </map>
</a></div>
</div>
<div style="background-color:#ffc100;">
<div class="a"><a href="http://www.gjw.com/product/item-id-7189.htm" target="_blank"><img alt="" width="1040" height="438" usemap="#Map4" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_05.jpg" src="${base}/promotion_files/lp_05.jpg" style="display: inline;">
    <map name="Map4" id="Map4">
      <area shape="rect" coords="42,11,1041,398" href="http://www.gjw.com/product/item-id-2386.htm" target="_blank">
    </map>
</a></div>
</div>
<div style="background-color:#ffc100;">
<div class="a"><img alt="" width="1040" height="594" usemap="#Map5" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_06.jpg" src="${base}/promotion_files/lp_06.jpg" style="display: inline;">
  <map name="Map5" id="Map5">
    <area shape="rect" coords="43,204,1040,582" href="http://www.gjw.com/product/item-id-7290.htm" target="_blank">
  </map>
</div>
</div>
<div style="background-color:#ffc100;">
<div class="a"><img alt="" width="1040" height="439" usemap="#Map6" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_07.jpg" src="${base}/promotion_files/lp_07.jpg" style="display: inline;">
  <map name="Map6" id="Map6">
    <area shape="rect" coords="5,8,339,434" href="http://www.gjw.com/product/item-id-7329.htm" target="_blank">
    <area shape="rect" coords="352,8,693,436" href="http://www.gjw.com/product/Item-ID-6282.htm" target="_blank">
    <area shape="rect" coords="700,4,1043,435" href="http://www.gjw.com/product/item-id-2422.htm" target="_blank">
  </map>
</div>
</div>
<div style="background-color:#ffc100;">
<div class="a"><img alt="" width="1040" height="417" usemap="#Map7" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_08.jpg" src="${base}/promotion_files/lp_08.jpg" style="display: inline;">
  <map name="Map7" id="Map7">
    <area shape="rect" coords="43,23,1040,411" href="http://www.gjw.com/product/item-id-7326.htm" target="_blank">
  </map>
</div>
</div>
<div style="background-color:#ffc100;">
<div class="a"><img alt="" width="1040" height="381" usemap="#Map8" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_09.jpg">
  <map name="Map8" id="Map8">
    <area shape="rect" coords="7,10,522,372" href="http://www.gjw.com/product/item-id-1545.htm" target="_blank">
    <area shape="rect" coords="531,6,1046,375" href="http://www.gjw.com/product/item-id-6343.html" target="_blank">
  </map>
</div>
</div>

<div style="background-color:#ffc100;">
<div class="a"><img alt="" width="1040" height="405" usemap="#Map9" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_10.jpg">
  <map name="Map9" id="Map9">
    <area shape="rect" coords="8,5,1040,399" href="http://www.gjw.com/product/item-id-7118.html" target="_blank">
  </map>
</div>
</div>
<div style="background-color:#ffc100;">
<div class="a"><img alt="" width="1040" height="438" usemap="#Map10" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_11.jpg">
  <map name="Map10" id="Map10">
    <area shape="rect" coords="4,12,342,446" href="http://www.gjw.com/product/item-id-7563.html" target="_blank">
    <area shape="rect" coords="351,4,695,435" href="http://www.gjw.com/product/item-id-4324.htm" target="_blank">
    <area shape="rect" coords="706,11,1053,441" href="http://www.gjw.com/product/item-id-7482.htm" target="_blank">
  </map>
</div>
</div>
<div style="background-color:#ffc100;">
<div class="a"><img alt="" width="1040" height="626" usemap="#Map11" border="0" original="http://img0.gjw.com/Minisite/2018/luy/6/6-9/LP/lp_12.jpg">
  <map name="Map11" id="Map11">
    <area shape="rect" coords="2,243,515,603" href="http://www.gjw.com/product/Item-ID-6989.htm" target="_blank">
    <area shape="rect" coords="527,237,1045,596" href="http://www.gjw.com/product/item-id-5189.htm" target="_blank">
  </map>
</div>
</div>
            ...
            <div class="footerMid">
                ...
                <div class="footer_link footer_center">
                    ...
                    <dl>
                        ...
                        <dd>
                            <a href="http://tm.gjw.com/linkShowList.htm">友情链接</a>
                        </dd>
                    </dl>
                    <dl>
                        <dt>合作共赢</dt>
        ...
        <div class="rightFixedBar">
            <div class="rightFixedBar_inner">
                ...
                <div href="" class="rb_btn rb_Center">
                    ...
                    <div class="iconBox_tips tips_qrcode">
                        <div class="tips_imgBox">
                            <a href="http://tm.gjw.com/"> 
                                <img src="${base}/promotion_files/APP.png" alt="" original="http://order.gjw.com/image/APP.png">
                            </a>
                        </div>
                        ...
                        <div href="" class="rb_btn rb_Center">
                            ...
                            <div class="iconBox_tips tips_zan">
                                <div class="tips_imgBox" id="tips_imgBox"><a href="http://www.gjw.com/product/item-id-3568.htm" target="_blank"><img src="${base}/promotion_files/00d84c57071640e69b4fae0cccbe2cf3.jpg" alt="" original="http://img0.gjw.com/Famous/2017/0721/00d84c57071640e69b4fae0cccbe2cf3.jpg"></a></div> <span class="tips_arrow">◆</span> </div> </div>
                ...
                </a><a href="http://tm.gjw.com/" class="rb_btn rb_Center" id="rightBar_backTop">
                    <div class="footer_iconBox">
 ...
 <style>
     ...
     display:none;
      ...
      <script src="${base}/promotion_files/swiper.min.js.下载"></script>
    <script src="${base}/promotion_files/jquery.lazyload.js.下载"></script>
        
<script src="${base}/promotion_files/layer.js.下载"></script>
        
         <script src="${base}/promotion_files/Order_index.min.js.下载"></script>
        <script src="${base}/promotion_files/main.min.js.下载"></script>
    ...
    <script type="text/javascript" src="${base}/promotion_files/ntkfstat.js.下载" charset="utf-8"></script>
         <script> 
...
<script src="${base}/promotion_files/z_stat.php" language="JavaScript"></script><script src="${base}/promotion_files/core.php" charset="utf-8" type="text/javascript"></script><a href="http://www.cnzz.com/stat/website.php?web_id=1253416101" target="_blank" title="站长统计">站长统计</a>
</p>

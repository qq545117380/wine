...
public class SendSms {
    ...
    static final String accessKeyId = "LTAItzX9UzNQ40X0";//你的accessKeyId,参考本文档步骤2
    static final String accessKeySecret = "GEREkT4gtQrpRpZE9EMcS3d8o3IBpH";//你的accessKeySecret，参考本文档步骤2

    //短信签名,例：云通信

    static String SignName = "fengkuan";

    //TemplateCode(必须):短信模板ID
    static String TemplateCode = "SMS_136510076";
